...
df = pd.read_csv('dataNormallestirme.csv', sep=';')
...
Y = df['Fiyat']
data_train, data_test, label_train, label_test = train_test_split(X,Y, test_size=0.1,random_state=23)
regr = linear_model.LinearRegression()
regr.fit(data_train, label_train)
A=regr.predict(data_test)
print(A)
